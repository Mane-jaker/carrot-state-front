...
function CardAgent({nombre,email,estado,ventas,propiedades}){
    return(
                ...
                <div className="row">
                    ...
                    <section className="col-8 info-agent">
                        <div className="row info-agent-data">
                            ...
                            <div className="col-10 space">{nombre}</div>
                        </div>
                        <div className="row info-agent-data">
                            <div className="col-2 the-info">Email:</div>
                            <div className="col-10 space">{email}</div>
                        </div>
                        <section className="row info-agent-multidata">
                                <div className="col-2 the-info">Estado:</div>
                                <div className="col-2 space">{estado}</div>
                                <div className="col-2 offset-1 the-info">Ventas:</div>
                                <div className="col-1 space">{ventas}</div>
                                <div className="col-2 offset-1 the-info">Propiedades:</div>
                                <div className="col-1 space">{propiedades}</div>
                        </section>
                    </section>
                </div>
            </div>
