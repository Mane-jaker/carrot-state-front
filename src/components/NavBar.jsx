        ...
        <>
            <div className={navBar ? 'nav-bar color' : 'nav-bar'}>{/*este esta en style general*/}
                <div className="row align-items-center">
                    ...
                    {isAgent == 3 && (
                        <>
                            <Link to={"/agentPage"} className='hs'><h1>Carroth State</h1></Link>
                        </>
                    )}
                    {isAgent == 4 && (
                        <>
                    ...
                    <div className="col-4 offset-4">
                        <div className="row align-items-center">
                            ...
                            {isAgent == 3 && (
                                <>
                                    <div className="col-4">
                                        <Link to={"/agentPage"} className='navp'>Propiedades</Link>
                                    </div>
                                    <div className="col-4">
                            ...
                            {isAgent == 4 && (
                                <>
                                    <div className="col-4">
                                        <Link to={"/clients"} className='navp'>Propiedades</Link>
                                    </div>
                                    <div className="col-4">
